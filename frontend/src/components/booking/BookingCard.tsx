          ...
          <div className="flex items-center gap-2 mb-1">
            ...
            {booking.customer.loyalty_rank && (
              <span className={cn(
                ...
                booking.customer.loyalty_rank === 'vip' && 'bg-purple-100 text-purple-800',
                booking.customer.loyalty_rank === 'premium' && 'bg-gold-100 text-gold-800',
                booking.customer.loyalty_rank === 'regular' && 'bg-blue-100 text-blue-800',
                booking.customer.loyalty_rank === 'new' && 'bg-green-100 text-green-800'
              )}>
