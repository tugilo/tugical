# tugical デプロイガイド（統合 Laravel アプリケーション版）
...
```yaml
# docker-compose.yml（統合Laravelアプリケーション）
version: "3.8"
services:
  # 統合Laravelアプリケーション（環境別設定）
  app:
    build:
      context: ./docker/php
      args:
