...
**多店舗・本部・横断**: 多店舗・本部・横断機能は **tugical+** に隔離する。本仕様の FUTURE は相棒まわり（心理設計・文言・パーソナライズ）に限定し、店舗横断・テナント管理は tugical+ として別途定義する。tugical は単店舗の相棒をコアとし、多店舗・本部・横断機能は tugical+（上位プラン/オプション）として将来追加する。
